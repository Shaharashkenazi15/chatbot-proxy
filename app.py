...
def chat():
  ...
  "content": (
      ...
      "בהמלצה על סרט, השתמש תמיד במבנה קבוע: שם הסרט (באנגלית), שנה, ז'אנר, דירוג, תקציר קצר בעברית."
      "אל תמציא שמות סרטים, תקצירים או פרטים שלא מופיעים בטבלה. אם אין מידע מתאים, הסבר זאת בקצרה והצע סרט כללי מהטבלה."
      "אל תתרגם את שם הסרט – השאר אותו באנגלית בלבד, בדיוק כמו שהוא מופיע בטבלה. "
